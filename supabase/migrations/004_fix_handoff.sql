-- Fix complete_work_item function to handle array to JSONB casting
-- Migration: 004_fix_handoff.sql
...
BEGIN
  ...
  INSERT INTO agent_activity (
    ...
    'handed_off',
    jsonb_build_object(
      'child_items', to_jsonb(v_child_ids), -- Explicit cast to JSONB
  ...
  RETURN jsonb_build_object(
    ...
    'child_items', to_jsonb(v_child_ids), -- Explicit cast to JSONB
    'validation_errors', to_jsonb(v_validation_errors) -- Explicit cast to JSONB
  );
END;
$$ LANGUAGE plpgsql;
