-- Fix complete_work_item function variable type mismatch
-- Migration: 005_fix_handoff_variable_types.sql
...
BEGIN
  ...
  INSERT INTO agent_activity (
    ...
    'handed_off',
    jsonb_build_object(
      'child_items', to_jsonb(v_child_ids), -- Explicit cast
  ...
  RETURN jsonb_build_object(
    ...
    'child_items', to_jsonb(v_child_ids), -- Explicit cast
    'validation_errors', to_jsonb(v_validation_errors) -- Explicit cast
  );
END;
$$ LANGUAGE plpgsql;
